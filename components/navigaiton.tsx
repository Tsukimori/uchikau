      ...
      <div className="flex h-full">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white focus:outline-none">
                  ...
                  <div className="h-0 flex-1 overflow-y-auto pt-5 pb-4">
                    ...
                    <div className="flex  flex-shrink-0  border-gray-200 px-4 mt-4">
                      <div className="flex items-center">
                        ...
                        <div className=" flex items-center gap-2 ml-3">
                          ...
                          <Link
                            className=" border rounded-full text-xs font-medium py-1 px-4 "
        ...
        <div className="hidden md:flex md:flex-shrink-0">
          <div className="flex w-64 flex-col">
            ...
            <div className="flex min-h-screen  flex-1 flex-col border-r  h-full">
              <div className="flex flex-1 flex-col overflow-y-auto pt-5 pb-4 ">
                ...
                <div className="flex flex-shrink-0  border-gray-200 p-4 mt-2">
                  <div className="flex items-center">
                    <div>
                      <Image
                        className=" inline-block rounded-full"
