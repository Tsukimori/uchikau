...
export default function MessageList() {
  const message = [
    {
      titel: "20221025ABCDに提案がありました",
      content:
        "初めまして、ウチカウホームズです。ご希望に近い物件がありますので・・・",
      send: "未送信",
      date: "1日前",
      company: "ウチカウホームズ",
    },
    {
      titel: "20221001OPKJDに提案がありました",
      content:
        "初めまして、東京不動産の田中と申します。ご希望に近い物件がありますので・・・",
      send: "返信済み",
      date: "2011.11.01",
      company: "東京不動産",
    },
    {
      titel: "20221001OPKJDに提案がありました",
      content:
        "先日は、ありがとうござしました。他にもご希望に近い物件がありましたので・・",
      send: "送信済み",
      date: "2022.10.31",
      company: "ウチカウホームズ",
    },
    ...
    <Layout>
      <article className=" text-xs py-8 px-4">
                ...
                <div key={item.titel} className=" flex gap-2 p-4 border-b mt-4">
                  ...
                  <div className=" space-y-2">
                    ...
                    <dl className="">
                      ...
                      <dd className="text-gray-400">{item.company}</dd>
                    </dl>
                  </div>
                </div>
              );
        ...
        <section className=" mt-12">
          <div className=" flex justify-center items-center py-2 px-4 border h-32 mt-4">
            <p>5件中</p>
